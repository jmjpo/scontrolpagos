...
Public Class rptPagosSocios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "scontrolpagos.rptPagosSocios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosSocios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosSocios = New rptPagosSocios()
        rpt.Site = Me.Site
        Return rpt
    End Function
