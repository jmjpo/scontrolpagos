...
Public Class rptPagosAtrasados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "scontrolpagos.rptPagosAtrasados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosAtrasados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosAtrasados = New rptPagosAtrasados()
        rpt.Site = Me.Site
        Return rpt
    End Function
