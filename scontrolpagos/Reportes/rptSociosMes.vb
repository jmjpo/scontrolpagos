...
Public Class rptSociosMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "scontrolpagos.rptSociosMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSociosMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSociosMes = New rptSociosMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
